package com.example.elasticjob.service.bo;
 ...
 * @author beldon
 */
public class JobPacketBO implements Serializable {
    ...
    public JobPacketBO(Class<? extends ElasticJob> elasticJobClass, String jobName, String cron, int shardingTotalCount) {
    ...
    public JobPacketBO(Class<? extends ElasticJob> elasticJobClass, String jobName, String cron, int shardingTotalCount, boolean singleJob) {
        this.elasticJobClass = elasticJobClass;
        this.jobName = jobName;
        this.cron = cron;
        this.shardingTotalCount = shardingTotalCount;
